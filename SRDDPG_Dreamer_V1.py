...
for i in range(MAX_EPISODES):
    ...
    for j in range(MAX_EP_STEPS):
        ...
        x_ = x + tau * x_dot
        x_dot_ = x_dot + tau * xacc
        theta_ = theta + tau * theta_dot
        theta_dot_ = theta_dot + tau * thetaacc
        ...
        s_pre=dreamer.dream(s,a,s_linear)

        # Save real s,a,s_,s_linear for RL
        dreamer.store_transition(s, a,s_linear, s_)
