...
class PPO(object):
    def __init__(self, a_dim, s_dim, a_bound,):
        ...
        self.saver.restore(self.sess, "Model/PPO_Lyapunov_V4.ckpt")  # 1 0.1 0.5 0.001
    ...
    def save_result(self):
        save_path = self.saver.save(self.sess, "Model/PPO_Lyapunov_V3.ckpt")
...
critic_error=100000
lyapnov_error=50000
EWMA_c_loss[0,0]=200000
EWMA_l_loss[0,0]=80000
